...
5. Executed the following command to log into the database, replaced <endpoint_goes_here> with the endpoint that I had  copied to my text editor.
   ...
   ```
   The following is a screenshot of the output I got after I ran the command in Step 2:
  ...
  Successfully configured the Amazon EC2 Linux instance to connect to Aurora.
...
3. Used `Create` statement to create a table named `country` in the `world` database
